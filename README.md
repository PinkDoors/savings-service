...
1. Логирование
2. Контейнеризация самого сервиса, а не только mongo и mongo-express.
3. Замена 400 ошибок на 200, если сохранение не было найдено.
4. Вынос логики поиска существующего сохранения перед созданием нового в слой сервиса (или попытка это сделать через 1 
подключение к бд).
5. Добавление ручки, которая будет искать сохранения по комбинации параметров: (userId, novelId),(userId),(novelId) 
6. Тесты
